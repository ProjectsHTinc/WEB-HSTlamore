                                            ...
                                            <div class="row">
                                                ...
                                                <div class="main-single-product fix">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="single-product">
                                                            ...
                                                            <div class="pro-img">
                                                                <a href="<?php echo base_url(); ?>product_details/">
                                                                    <img class="primary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/8_2.jpg" alt="single-product">
                                                                </a>
                                                                <div class="quick-view">
                                                                    <a href="#" data-toggle="modal" data-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <!-- Product Content Start -->
                                                        <div class="thubnail-desc fix">
                                                            <h4 class="product-header"><a href="<?php echo base_url(); ?>product_details/">Modern Desk Lamp</a></h4>
                                                            <!-- Product Price Start -->
                                                            <div class="pro-price mb-15">
                                                                <ul class="pro-price-list">
                                                ...
                                                <div class="main-single-product fix">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <!-- Product Content Start -->
                                                        <div class="thubnail-desc fix">
                                                            <h4 class="product-header"><a href="<?php echo base_url(); ?>product_details/">Congue Sitamet</a></h4>
                                                            <!-- Product Price Start -->
                                                            <div class="pro-price mb-15">
                                                                <ul class="pro-price-list">
                                                ...
                                                <div class="main-single-product fix">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <!-- Product Content Start -->
                                                        <div class="thubnail-desc fix">
                                                            <h4 class="product-header"><a href="<?php echo base_url(); ?>product_details/">Nulla Massa Est</a></h4>
                                                            <!-- Product Price Start -->
                                                            <div class="pro-price mb-15">
                                                                <ul class="pro-price-list">
                                                ...
                                                <div class="main-single-product fix">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <div class="single-product">
                                                            ...
                                                            <div class="pro-img">
                                                                <a href="<?php echo base_url(); ?>product_details/">
                                                                    <img class="primary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/5_1.jpg" alt="single-product">
                                                                </a>
                                                                <div class="quick-view">
                                                                    <a href="#" data-toggle="modal" data-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-8">
                                                        <!-- Product Content Start -->
                                                        <div class="thubnail-desc fix">
                                                            <h4 class="product-header"><a href="<?php echo base_url(); ?>product_details/">Placerat Volutpat</a></h4>
                                                            <!-- Product Price Start -->
                                                            <div class="pro-price mb-15">
                                                                <ul class="pro-price-list">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="<?php echo base_url(); ?>product_details/">Modern Desk Lamp</a></h4>
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="<?php echo base_url(); ?>product_details/">Nulla massa est</a></h4>
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="<?php echo base_url(); ?>product_details/">
                                                                <img class="primary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/5_1.jpg" alt="single-product">
                                                                <img class="secondary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/4_1.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="<?php echo base_url(); ?>product_details/">Splacerat volutpat</a></h4>
                                                ...
                                                <div class="col-md-4 col-sm-6">
                                                    ...
                                                    <div class="single-product">
                                                        ...
                                                        <div class="pro-img">
                                                            <a href="<?php echo base_url(); ?>product_details/">
                                                                <img class="primary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/8_1.jpg" alt="single-product">
                                                                <img class="secondary-img" src="<?php echo base_url(); ?>assets/front/img/new-products/8_2.jpg" alt="single-product">
                                                            </a>
                                                            <div class="quick-view">
                                                                <a href="#" data-toggle="modal" data-target="#myModal"><i class="pe-7s-look"></i>quick view</a>
                                                            </div>
                                                        ...
                                                        <!-- Product Content Start -->
                                                        <div class="pro-content text-center">
                                                            <h4><a href="<?php echo base_url(); ?>product_details/">Maple Wood Table</a></h4>
