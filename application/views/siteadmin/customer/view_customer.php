	...
	<div class="container-fluid">
          <div class="row">
                  ...
                  <li><a href="<?php echo base_url(); ?>adminlogin/home">Dashboard</a></li>
    							<li><a href="<?php echo base_url(); ?>admin/products"><span> Customer </span></a></li>
											...
											<table class="table display responsive product-overview mb-30" id="myTable">
												...
												<tbody>
													...
													<tr>
														...
														<td>
									<a href="<?php echo base_url(); ?>admin/customer_details/<?php echo base64_encode($row_cus->id*9876); ?>" class="text-inverse p-r-10" data-toggle="tooltip" title="View Address" ><i class="icon-list"></i></a>
