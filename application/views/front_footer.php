                                        ...
                                        <div class="col-md-5 col-sm-6">
                                            ...
                                            <div class="tab-content">
                                                <div id="thumb1" class="tab-pane fade in active">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/1_1.jpg" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb2" class="tab-pane fade">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/1_2.jpg" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb3" class="tab-pane fade">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/2_1.jpg" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb4" class="tab-pane fade">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/2_2.jpg" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb5" class="tab-pane fade">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/3_1.jpg" alt="product-thumbnail"/>
                                                </div>
                                                <div id="thumb6" class="tab-pane fade">
                                                    <img src="<?php echo base_url(); ?>assets/front/img/new-products/3_2.jpg" alt="product-thumbnail"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="product-thumbnail mt-15 mb-20">
                                                <div class="thumb-menu owl-carousel">
                                                    <div class="active">
                                                        <a data-toggle="tab" href="#thumb1"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/1_1.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-toggle="tab" href="#thumb2"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/1_2.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-toggle="tab" href="#thumb3"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/2_1.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-toggle="tab" href="#thumb4"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/2_2.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-toggle="tab" href="#thumb5"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/3_1.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                    <div>
                                                        <a data-toggle="tab" href="#thumb6"> <img src="<?php echo base_url(); ?>assets/front/img/new-products/3_2.jpg" alt="product-thumbnail"></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- Thumbnail image end -->
