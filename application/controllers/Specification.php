...
class Specification extends CI_Controller {
		...
		if($user_role=='1' || $user_role=='2'){
				...
				$category_cover_image = $_FILES['cat_cover_img']['name'];
					...
					$category_thumb_image = $_FILES['cat_thumb_img']['name'];
						...
						$data=$this->specificationmodel->update_category($cat_name,$cat_desc,$cat_status,$cat_meta_title,$cat_meta_desc,$cat_meta_keywords,$cat_cover_img,$cat_thumb_img,$user_id,$cat_id);
	...
	public function check_category_exist(){
		...
		$cat_name= $this->db->escape_str($this->input->post('cat_name'));
		$data=$this->specificationmodel->check_category_exist($cat_id,$cat_name,$user_id);
	}
	...
	public function add_sub()
	{
		...
		$user_role=$this->session->userdata('role_type_id');
			if($user_role=='1' || $user_role=='2'){
				$data['res']=$this->specificationmodel->get_all_category();
				$this->load->view('siteadmin/header',$data);
				$this->load->view('siteadmin/category/sub_category',$data);
				$this->load->view('siteadmin/footer');
		}else{
			$this->load->view('siteadmin/login');
		}
	...
	public function view_sub()
	{
		...
		$user_role=$this->session->userdata('role_type_id');
			if($user_role=='1' || $user_role=='2'){
				...
				$data['res']=$this->specificationmodel->get_all_subcategory($sub_cat);
				$this->load->view('siteadmin/header',$data);
				$this->load->view('siteadmin/category/view_sub_category',$data);
				$this->load->view('siteadmin/footer');
		}else{
			$this->load->view('siteadmin/login');
		}
	...
	public function edit_cat()
	{
		...
		$user_role=$this->session->userdata('role_type_id');
			if($user_role=='1' || $user_role=='2'){
				$cat_id=$this->uri->segment(3);
				$data['res']=$this->specificationmodel->get_category_edit($cat_id);
				$this->load->view('siteadmin/header',$data);
				$this->load->view('siteadmin/category/edit_cat',$data);
				$this->load->view('siteadmin/footer');
		}else{
			$this->load->view('siteadmin/login');
		}
		...
		if($user_role=='1' || $user_role=='2'){
				...
				$category_cover_image = $_FILES['cat_cover_img']['name'];
					...
					$category_thumb_image = $_FILES['cat_thumb_img']['name'];
						...
						$data=$this->specificationmodel->create_sub_category($cat_name,$cat_desc,$cat_status,$cat_meta_title,$cat_meta_desc,$cat_meta_keywords,$cat_cover_img,$cat_thumb_img,$user_id,$sub_cat_id);
						if($data['status']=="success"){
	...
	public function edit_sub_cat()
	{
		...
		$user_role=$this->session->userdata('role_type_id');
			if($user_role=='1' || $user_role=='2'){
				$data['main_cat']=$this->specificationmodel->get_all_parent_category();
				$cat_id=$this->uri->segment(3);
				$data['res']=$this->specificationmodel->get_category_edit($cat_id);
				$this->load->view('siteadmin/header',$data);
				$this->load->view('siteadmin/category/edit_sub_cat',$data);
				$this->load->view('siteadmin/footer');
		}else{
			$this->load->view('siteadmin/login');
		}
				...
				if($user_role=='1' || $user_role=='2'){
						...
						$category_cover_image = $_FILES['cat_cover_img']['name'];
							...
							$category_thumb_image = $_FILES['cat_thumb_img']['name'];
								...
								$data=$this->specificationmodel->update_sub_category($cat_name,$cat_desc,$cat_status,$cat_meta_title,$cat_meta_desc,$cat_meta_keywords,$cat_cover_img,$cat_thumb_img,$user_id,$cat_id,$main_cat_id);
